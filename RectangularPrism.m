function [vertex,face,faceNormals, rect_h] = RectangularPrism(lower,upper,plotOptions,axis_h)
if nargin<4
        axis_h=gca;
    if nargin<3
...
if isfield(plotOptions,'plotFaces') && plotOptions.plotFaces
    ...
    rect_h = patch('Faces',face,'Vertices',vertex,'FaceVertexCData',tcolor,'FaceColor','flat','lineStyle','none');
end
